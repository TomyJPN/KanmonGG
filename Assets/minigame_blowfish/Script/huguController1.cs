...
public class huguController1 : MonoBehaviour {
	...
	void Start () {
        ...
        Blowfish[0] = GameObject.Find("Blowfish (2)");
        Blowfish[1] = GameObject.Find("Blowfish (3)");
        Blowfish[2] = GameObject.Find("Blowfish (4)");
        Blowfish[3] = GameObject.Find("Blowfish (5)");
        Blowfish[4] = GameObject.Find("Blowfish (6)");
        huguScript2 = Blowfish[0].GetComponent<huguController2>();
        huguScript3 = Blowfish[1].GetComponent<huguController3>();
