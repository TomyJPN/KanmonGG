...
public class huguController6 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Blowfish[2] = GameObject.Find("Blowfish (3)");
        Blowfish[3] = GameObject.Find("Blowfish (4)");
        Blowfish[4] = GameObject.Find("Blowfish (5)");
        huguScript1 = Blowfish[0].GetComponent<huguController1>();
        huguScript2 = Blowfish[1].GetComponent<huguController2>();
        huguScript3 = Blowfish[2].GetComponent<huguController3>();
        huguScript4 = Blowfish[3].GetComponent<huguController4>();
        huguScript5 = Blowfish[4].GetComponent<huguController5>();
